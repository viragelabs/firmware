 ...
 */
  ...
  GetTopic_P(stopic, prefix, unique_id, romram);
...
void MqttPublishPrefixTopicb_P(uint32_t prefix, const char* subtopic, bool retained)
{
/* prefix 0 = cmnd using subtopic
 * prefix 1 = stat using subtopic
 * prefix 2 = tele using subtopic
...
{
  MqttPublishPrefixTopicb_P(prefix, subtopic, retained);
  XdrvRulesProcess();
}
...
const char HTTP_FORM_MQTT1[] PROGMEM =
  "<fieldset><legend align='center'><b>&nbsp;" D_MQTT_PARAMETERS "&nbsp;</b></legend>"
